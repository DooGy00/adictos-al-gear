        ...
        start: function(d, g) {
            ...
            switch (d) {
                ...
                case "pm":
                    ...
                    var g = $(".post").parents().find('a[href^="/u"]:not(:empty)').eq(0).text();
              $("#editor-post-tool").append('<span class="mp-msg" style="margin-top:8px;position:absolute;margin-left:5px;color:#fff;">Mensaje para:'+ g +'</span>');
                    break
            }
        },
        add: function(a, m) {
