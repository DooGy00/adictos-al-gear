...
if (lin || ps || mp) {
    ...
    $(".sceditor-button-headers").add(".sceditor-button-pastetext").add(".sceditor-button-dailymotion").add(".sceditor-button-horizontalrule").add(".sceditor-button-time").remove();
